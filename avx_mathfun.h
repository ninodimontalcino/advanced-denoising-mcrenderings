...
#define _PS256_CONST_TYPE(Name, Type, Val)                                 \
  static const ALIGN32_BEG Type _ps256_##Name[8] ALIGN32_END = { static_cast<int>(Val), static_cast<int>(Val), static_cast<int>(Val), static_cast<int>(Val), static_cast<int>(Val), static_cast<int>(Val), static_cast<int>(Val), static_cast<int>(Val) }
