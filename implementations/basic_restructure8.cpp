...
/*! -------------------------------------------------------
	Restructured Implementaton with Precomputation (VECTORIZED) with Blocking
    --> Doing Overhead Computations
 ...
 */
 void basic_restructure8(buffer out_img, buffer c, buffer c_var, buffer f, buffer f_var, int R, int W, int H){
