 ...
 */
 void basic_restructure5(buffer out_img, buffer c, buffer c_var, buffer f, buffer f_var, int R, int img_width, int img_height){
    ...
    filtering_basic_f3_VEC(f_filtered, f, f, f_var, p_pre, img_width, img_height);
    filtering_basic_f3_VEC(f_var_filtered, f_var, f, f_var, p_pre, img_width, img_height);
    ...
    candidate_filtering_FIRST_VEC(r, c, c_var, f_filtered, f_var_filtered, p_r, img_width, img_height);
    ...
    candidate_filtering_SECOND_VEC(g, c, c_var, f_filtered, f_var_filtered, p_g, img_width, img_height);
    ...
    candidate_filtering_THIRD_VEC(b, c, c_var, f_filtered, f_var_filtered, p_b, img_width, img_height);
